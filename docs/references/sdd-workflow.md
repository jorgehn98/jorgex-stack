...
Las simplificaciones sustanciales siguen la regla canónica de [simplificaciones sustanciales](../../stack/skills/orchestrator/SKILL.md#substantial-simplifications): si reducen de forma significativa la complejidad estructural o cognitiva, preservan el comportamiento y quedan dentro del alcance, deben aplicarse y verificarse antes de marcar el trabajo como ready o cerrarlo, aunque no corrijan un fallo funcional. Aplazarlas exige una decisión explícita de la persona usuaria; si implican ampliar el alcance o dejan un riesgo sin resolver, el coordinador debe elevar esa decisión antes de implementar o cerrar, sin autorizar escritura insegura ni un cierre silencioso. Los nits cosméticos y las mejoras menores siguen siendo no bloqueantes. Una auditoría read-only por sí sola no autoriza escrituras.
