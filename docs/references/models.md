...
`jorgex-pi@0.8.3` —no los adapters de Stack— gestiona la proyección primaria del release publicado (`npm:jorgex-pi@0.8.3`). El Stack publicado `1.9.4` reconoce este pin:
